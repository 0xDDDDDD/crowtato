local decrees = {
        {
            id = 1,
            name = "Full Moon",
            tooltip = "Increases damage by 20% but reduces speed by 10% during every 5th wave",
        ...
        },
        {
            id = 5,
            name = "Devourer",
            tooltip = "2.5% chance to heal 10% of HP on enemy kill",
        ...
        },
        {
            id = 13,
            name = "Ghost Pepper",
            tooltip = "Enemies within 3m constantly take 10 damage",
        ...
        },
        {
            id = 19,
            name = "The Law",
            tooltip = "When no enemies are within 3m, fire a 20 dmg projectile every 3 seconds",
